...
import { exportarResultadosValidarOficinasAExcel, leerDatosDesdeExcel } from '@/utils/helpers'
...
test('Validar direcciónes no georreferenciadas (address_id = 0)', async () => {
  ...
  // ✅ Exportar al final
  exportarResultadosValidarOficinasAExcel(resultadosValidacion, 'resultados_validacion_oficinas_lonLat')
